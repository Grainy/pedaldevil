...
module.exports = function (gulp, plugins, onError, browserSync) {
    return function () {
    	...
    	return plugins.sass('app/scss/async-page-builder.scss', { sourcemap: true, require: ['breakpoint']  })
    	//catch errors
		...
		.pipe(plugins.concat('async-page-builder.css')).pipe(plugins.minifyCSS())
		.pipe(plugins.buffer())
		.pipe(plugins.rev())

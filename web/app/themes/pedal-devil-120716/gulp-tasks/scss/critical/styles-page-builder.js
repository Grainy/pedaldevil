...
module.exports = function (gulp, plugins, onError, browserSync) {
    return function () {
    	...
    	return plugins.sass('app/scss/critical-page-builder.scss', { sourcemap: true, require: ['breakpoint']  })
		...
		.pipe(plugins.concat('critical-page-builder.css')).pipe(plugins.minifyCSS())
		//.pipe(plugins.buffer())
		//.pipe(plugins.rev())

...
module.exports = function (gulp, plugins, onError, browserSync) {
    return function () {
    	...
    	return plugins.sass('app/scss/critical-single-post.scss', { sourcemap: true, require: ['breakpoint'] })
		...
		.pipe(plugins.concat('critical-single-post.css')).pipe(plugins.minifyCSS())
		//.pipe(plugins.buffer())
		//.pipe(plugins.rev())

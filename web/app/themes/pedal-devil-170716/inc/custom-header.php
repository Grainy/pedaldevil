 ...
 *
 * @uses _header_style()
 * @uses _admin_header_style()
 * @uses _admin_header_image()
 */
function _custom_header_setup() {
	add_theme_support( 'custom-header', apply_filters( '_custom_header_args', array(
		'default-image'          => '',
...
add_action( 'after_setup_theme', '_custom_header_setup' );

if ( ! function_exists( '_header_style' ) ) :
/**
 * Styles the header image and text displayed on the blog
 *
 * @see _custom_header_setup().
 */
